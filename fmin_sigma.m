...
% Z =
% -log(0.6096*(1/sqrt(2*pi*d1(8))*exp(-(X-x1(8)).^2/(2*d1(8)))).*(1/sqrt(2*pi*d1(5))*exp(-(Y-x1(5)).^2/(2*d1(5))))
% +
% 0.0752*(1/sqrt(2*pi*d2(8))*exp(-(X-x2(8)).^2/(2*d2(8)))).*(1/sqrt(2*pi*d2(5))*exp(-(Y-x2(5)).^2/(2*d2(5))))
% +
% 0.3152*(1/sqrt(2*pi*d3(8))*exp(-(X-x3(8)).^2/(2*d3(8)))).*(1/sqrt(2*pi*d3(5))*exp(-(Y-x3(5)).^2/(2*d3(5)))));
% %a=1.1,b=2,k=1
